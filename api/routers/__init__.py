...
- reports: Router per report PDF giornalieri (GET /api/reports/daily/{user_id})
"""
from . import ingest, snapshot, movements, diagnostics, admin, reports

__all__ = ["ingest", "snapshot", "movements", "diagnostics", "admin", "reports"]
